...
np.save('dates_sparkling.npy',new_dates)
...
np.save('features_sparkling.npy',x_raw_full_new)
...
np.save('processed_features_sparkling.npy',x_full)
...
np.save('labels_sparkling.npy',labels)


# phy files ------------------------------------------------------------

#diag_all = pd.read_feather('../Generic_GLM_sparkling_diagnostics.feather')
#diag_all.columns
#idx = [-11,-10,3]
...
np.save('diag_sparkling.npy',diag)
...
#
#train_data = pd.read_feather('../experiment_01/sparkling_training_002profiles_experiment_01.feather')
#train_data.columns
#
...
#
#    
#test_data = pd.read_feather('../experiment_01/sparkling_test_experiment_01.feather')
#test_data.columns
#
